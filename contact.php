        ...
        <div class="row gx-0 d-none d-lg-flex">
            <div class="col-lg-7 px-5 text-start">
                <div class="h-100 d-inline-flex align-items-center py-3 me-3">
                    ...
                    <a class="text-body px-2" href="mailto:contacte@lamezardiere.com"><i class="fa fa-envelope-open text-primary me-2"></i>contacte@lamezardiere.com</a>
                </div>
            </div>
...
<!--                 <div class="nav-item dropdown">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h4 class="section-title">Contacter Nous</h4>
                    ...
                    <div class="d-flex flex-column justify-content-between h-100">
                        <div class="bg-light d-flex align-items-center w-100 p-4 mb-4">
                            ...
                            <div class="ms-4">
                                ...
                                <h3 class="mb-0">La Mezardière Résidence, Arsenal, Ile Maurice</h3>
                            </div>
                        </div>
                        <div class="bg-light d-flex align-items-center w-100 p-4 mb-4">
                            <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-dark" style="width: 55px; height: 55px;">
                            ...
                            <div class="ms-4">
                                ...
                                <h3 class="mb-0">Tel: +230 5255 4150</h3>
                                  <h3 class="mb-0">Whatsapp: +230 5934 9535</h3>
                                  <h3 class="mb-0">Whatsapp: +230 5842 7162</h3>
                        ...
                        <div class="bg-light d-flex align-items-center w-100 p-4">
                            ...
                            <div class="ms-4">
                                ...
                                <h3 class="mb-0">contacte@lamezardiere.com</h3>                              
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <p class="mb-4">Veuillez remplir le formulaire ci-dessous pour obtenir plus d’informations sur La Mezardière.<!--  <a href="https://htmlcodex.com/contact-form">Download Now</a>.</p>-->
                    ...
                    <!-- <?php
                        if (isset($_POST['message'])) {
                            $retour = mail('rualgondol@gmail.com', 'Envoi depuis la page Contact', $_POST['message'], 'From: webmaster@lamezardiere.mu' . "\r\n" . 'Reply-to: ' . $_POST['email']);
                            if($retour)
    ...
    <div class="container-xxl pt-5 px-0 wow fadeIn" data-wow-delay="0.1s">
        <iframe class="w-100 mb-n2" style="height: 450px;"
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d20898.735714081322!2d57.536216799727846!3d-20.109496281717924!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x217c5392f343c731%3A0xddcc852106c170cb!2sArsenal!5e0!3m2!1sen!2smu!4v1648210562465!5m2!1sen!2smu"
